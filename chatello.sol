...
/**
 *Submitted for verification at mumbai.polygonscan.com on 2023-12-29
*/
...
contract Chatello is ERC20, ERC20Burnable, Ownable, ERC20Permit {
        uint256 _maxSupply = 1000000000 * 10 ** decimals();

        constructor(address initialOwner)
        ERC20("Chatello", "Chatello")
        Ownable(initialOwner)
        ERC20Permit("Chatello")
    {
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        ...
        require (newSupply <= _maxSupply, "Error: Maximum token supply reached.");
        _mint(to, amount);
    }
}
